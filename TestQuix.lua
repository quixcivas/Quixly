...
print("X5 Speed Balanced Method - Anti Rate Limit!")
...
WindUI:AddTheme({
    ...
    Accent = WindUI:Gradient({
        ...
        ["50"]  = { Color = Color3.fromHex("#FF3366"), Transparency = 0 },  -- biru Cerah
        ["100"] = { Color = Color3.fromHex("#FF3366"), Transparency = 0 },  -- Ungu Terang
    }, {
        Rotation = 45,
    }),
    ...
    Placeholder = Color3.fromHex("#33FFEE"),    -- Ungu-merah pudar
    Background = Color3.fromHex("#050008"),     -- Hitam pekat dengan nuansa ungu
    Button = Color3.fromHex("#33FFEE"),         -- Biru ke ungu neon
    Icon = Color3.fromHex("#33FFEE")            -- Aksen biru
})
...
Home:Paragraph({
	...
	Color = "Blue",
	Desc = [[
Just for fun ur gameplay
TikTok Channel = @chadichaa
Thanks QuixFams.
]]
})
...
_G.REReplicateCutscene.OnClientEvent:Connect(function(rarity, player, position, fishName, data)
    if _G.BlockCutsceneEnabled then
        print("[AeHUB] Cutscene diblokir:", fishName, "(Rarity:", rarity .. ")")
...
_G.ArtifactParagraph = AutoFarmTab:Paragraph({
