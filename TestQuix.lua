...
_G.AutoFishingNewMethod = function()
    ...
    task.spawn(function()
        ...
        while Config.AutoFishingNewMethod and RuntimeState.IsFishingNewMethod do
            ...
            -- Auto-restart if no activity for 1 minutes
            if tick() - lastSuccessTime > 60 then
                warn("[AutoFishingNewMethod] No activity for 1 minutes, auto-restarting...")
...
function StopAutoFish5X()
    ...
    -- Hentikan proses memancing
    _G.StopFishing()

    -- Matikan semua status/spam
    _G.isSpamming = false
    _G.rSpamming = false
    _G.isRecasting5x = false

    -- Hentikan semua thread aktif (auto fish, spam, dll)
    ...
    -- Matikan recovery loop kalau ada
